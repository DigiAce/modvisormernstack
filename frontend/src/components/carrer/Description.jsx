...
const Discription = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${VITE_BACKEND_URL}/api/submit-form`,
        formDataToSend,
        {
          headers: {
  ...
  return (
    <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-16 mb-12 mt-12 sm:mb-16">
      ...
      {showForm && (
        <div className="fixed inset-0 flex justify-center items-center p-10 mt-32 sm:mt-20">
          <div className="bg-white p-8 rounded-2xl shadow-lg max-w-lg w-full relative mt-10">
            <button
